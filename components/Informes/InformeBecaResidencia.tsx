    ...
    try {
      const contenidoHTML = `
        ...
        <body>
          ...
          <h2>Beca de Residencia 2026</h2>
          <p><strong>Datos proporcionados:</strong></p>
          <ul>
            <li><strong>¿Estás matriculado en estudios postobligatorios o universitarios?</strong> ${
              matriculado === "S" ? "Sí" : "No"
            }</li>
            <li><strong>¿Tu residencia habitual está lejos del centro de estudios?</strong> ${
              residenciaLejana === "S" ? "Sí" : "No"
            }</li>
            <li><strong>¿Estás cursando estudios presenciales y con matrícula completa?</strong> ${
              estudiosPresenciales === "S" ? "Sí" : "No"
            }</li>
            <li><strong>¿Tienes alguna discapacidad reconocida?</strong> ${
          ...
          <h3>Descripción:</h3>
          <p>La Beca de Residencia 2026 está destinada a estudiantes que deben trasladarse lejos de su residencia habitual para cursar estudios presenciales. Esta beca considera factores como la matriculación, distancia de residencia, tipo de estudios, discapacidad e ingresos familiares.</p>
