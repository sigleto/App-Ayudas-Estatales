    ...
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.content}>
          El Ingreso Mínimo Vital es una prestación dirigida a prevenir el
          riesgo de pobreza y exclusión social de las personas que viven solas o
        ...
        <Text style={styles.content}>
          ...
          convivencia debe estar formada desde hace seis meses.{"\n"}
        ...
        <Text style={styles.content}>
          La cuantía del ingreso mínimo vital (IMV) se establece en **700 euros
          mensuales** (8.400 euros anuales) para un adulto en 2026.
        </Text>

        <Text style={styles.subtitle}>Proceso de Solicitud</Text>
        <Text style={styles.content}>
          La solicitud se realiza en la Seguridad Social mediante su plataforma
          online o en oficinas físicas. Puede hacerlo a través de la Sede
          Electrónica de la Seguridad Social, tanto con certificado electrónico
          como sin él.
        </Text>

        <Text style={styles.subtitle}>Normativa</Text>
        <Text style={styles.content}>
          Regulado por el Real Decreto-ley 20/2020, de 29 de mayo, y dentro del
