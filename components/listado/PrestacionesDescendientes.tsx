...
type RutasNavegacion =
  | "AyudaNacimientoAdopcion"
  | "PrestacionHijoDiscapacidad"
  | "ComplementoAyudaInfancia";
...
const AyudaDescendientes = () => {
  ...
  const apartados: Apartado[] = [
    {
      nombre: "Ayuda general por nacimiento o adopción",
      ruta: "AyudaNacimientoAdopcion",
    },
    {
      nombre: "Prestación por hijo con discapacidad",
      ruta: "PrestacionHijoDiscapacidad",
    },
    {
      nombre: "Complemento de ayuda para la infancia",
      ruta: "ComplementoAyudaInfancia",
    },
  ];
