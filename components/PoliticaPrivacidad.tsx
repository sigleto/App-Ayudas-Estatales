...
const PoliticaPrivacidad: React.FC = () => {
  ...
  {"Se ha construido la aplicación Ayudas Públicas como una aplicación gratuita. Este SERVICIO es proporcionado sin costo alguno y está destinado a ser utilizado tal cual. Esta página se utiliza para informar a los usuarios sobre nuestras políticas con respecto a la recopilación, el uso y la divulgación de Información personal si alguien decide utilizar este Servicio.\n\n" +
