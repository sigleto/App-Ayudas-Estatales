...
const InformeAyudasDesacopladas: React.FC = () => {
  ...
  const generarPDF = async () => {
    try {
      const contenidoHTML = `
        ...
        <body>
          <h1>Informe de Simulación 2026</h1>
          ...
          <ul>
            ...
            <li><strong>¿Cumples criterios de sostenibilidad?</strong> ${
              sostenibilidad === "S" ? "Sí" : "No"
            }</li>
            <li><strong>¿Eres agricultor activo registrado?</strong> ${
              agricultorActivo === "S" ? "Sí" : "No"
            }</li>
            <li><strong>¿Cumples la normativa PAC vigente?</strong> ${
              cumpleNormativa === "S" ? "Sí" : "No"
            }</li>
            <li><strong>Ubicación de las tierras:</strong> ${ubicacion}</li>
            <li><strong>Puntos de sostenibilidad:</strong> ${puntosSostenibilidad}</li>
            <li><strong>¿Aplicas prácticas regenerativas?</strong> ${
              practicasRegenerativas === "S" ? "Sí" : "No"
            }</li>
            <li><strong>¿Participas en formación continua?</strong> ${
              formacionContinua === "S" ? "Sí" : "No"
            }</li>
            <li><strong>¿Usas agricultura de precisión?</strong> ${
              agriculturaPrecision === "S" ? "Sí" : "No"
            }</li>
          </ul>
          <h3>Resultado de la simulación:</h3>
          <p class="highlight">${resultado}</p>
          <h3>Descripción:</h3>
          <p>Las ayudas desacopladas de la PAC 2026 están diseñadas para apoyar a los agricultores que cumplen criterios relacionados con el tipo de cultivo, sostenibilidad, prácticas regenerativas, formación continua y uso de tecnologías de precisión.</p>
          ...
          <p>Nota: Este informe tiene un propósito informativo y no garantiza la concesión de las ayudas. Verifica siempre con las autoridades competentes y consulta las últimas actualizaciones para 2026.</p>
        </body>
        </html>
      `;
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Informe del Simulador 2026</Text>
