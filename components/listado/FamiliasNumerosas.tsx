...
type RutasNavegacion = 'AyudaNacimientoAdopcion' | 'PrestacionHijoDiscapacidad'; // Añade aquí otras rutas si las hay
...
const FamiliasNumerosas = () => {
  ...
  const apartados: Apartado[] = [
    ...
    { nombre: 'Prestacion por hijo con discapacidad', ruta: 'PrestacionHijoDiscapacidad' },
