...
import MovesIII from "./desgloseAyudas/EficienciaEnergetica/AyudaMoves";
import AyudaRehabilitacionEdificios from "./desgloseAyudas/EficienciaEnergetica/AyudaRehabilitacion";
import AyudaEnergiasRenovables from "./desgloseAyudas/EficienciaEnergetica/EnergiasRenovables";
import EficienciaEnergetica from "./listado/EficienciaEnergetica";
...
import SimuladorMovesIII from "./Simuladores/SimuladorMoves";
import SimuladorRehabilitacion from "./Simuladores/SimuladorRehabilitacion";
import SimuladorRenovables from "./Simuladores/SimuladorRenovables";
...
export function AyudasStack() {
  return (
    <Stack.Navigator>
      <Stack.Screen
        name="ListadoAyudas"
        component={ListadoAyudas}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SubsidiosDesempleo"
        component={SubsidiosDesempleo}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PrestacionContributiva"
        component={PrestacionContributiva}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SubsidiosPorDesempleo"
        component={SubsidiosPorDesempleo}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PrestacionesJubilacion"
        component={PrestacionesJubilacion}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="AyudasVivienda"
        component={AyudasVivienda}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="EficienciaEnergetica"
        component={EficienciaEnergetica}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="AyudaDescendientes"
        component={AyudaDescendientes}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="BecasEstudio"
        component={BecasEstudio}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Emprendedores"
      ...
      />
      <Stack.Screen
        name="Aval20PorCiento"
        component={Aval20PorCiento}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="AyudasParaJovenes"
        component={AyudasParaJovenes}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="AyudasAlAlquiler"
        component={AyudasAlAlquiler}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="BecaGeneral"
        component={BecaGeneral}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="BecaApoyoEducativo"
        component={BecaApoyoEducativo}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="BecaResidencia"
      ...
      />
      <Stack.Screen
        name="IngresoMinimoVital"
        component={IngresoMinimoVital}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PensionNoContributiva"
        component={PensionNoContributiva}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SubsidiosEspecificos"
        component={SubsidiosEspecificos}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="AyudaNacimientoAdopcion"
        component={AyudaNacimientoAdopcion}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PrestacionHijoDiscapacidad"
        component={PrestacionHijoDiscapacidad}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="EnisaEmprendedores"
        component={EnisaEmprendedores}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="KitDigital"
      ...
      <Stack.Screen
        name="AyudasSociales"
        component={AyudasSociales}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="LeyDependencia"
        component={LeyDependencia}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="ComplementoAyudaInfancia"
        component={ComplementoAyudaInfancia}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="BonoCulturalJoven"
        component={BonoCulturalJoven}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Cultura"
      ...
      />
      <Stack.Screen
        name="AyudasDesacopladas"
        component={AyudasDesacopladas}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="MedidasDesarrolloRural"
        component={MedidasDesarrolloRural}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="AyudaMoves"
      ...
      />
      <Stack.Screen
        name="AyudaRehabilitacion"
        component={AyudaRehabilitacionEdificios}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="AyudaRenovables"
        component={AyudaEnergiasRenovables}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="SimuladorIngresoMinimoVital"
        component={SimuladorIngresoMinimoVital}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorLeyDeDependencia"
        component={SimuladorLeyDeDependencia}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorPensionNoContributiva"
        component={SimuladorPensionNoContributiva}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorSubsidioMovilidad"
        component={SimuladorSubsidioMovilidad}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorAsistenciaSanitaria"
        component={SimuladorAsistenciaSanitaria}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorBecaApoyoEducativo"
        component={SimuladorBecaApoyoEducativo}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorBecaGeneral"
        component={SimuladorBecaGeneral}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorBecaResidencia"
        component={SimuladorBecaResidencia}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorAyudaNacimiento"
        component={SimuladorAyudaNacimiento}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorPrestacionHijoDiscapacidad"
        component={SimuladorPrestacionHijoDiscapacidad}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorAyudaJovenesAlquiler"
        component={SimuladorAyudaJovenesAlquiler}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorAyudaJovenesAdquisicion"
        component={SimuladorAyudaJovenesAdquisicion}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorAyudasAlquiler"
        component={SimuladorAyudasAlquiler}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorAvalHipoteca"
        component={SimuladorAvalHipoteca}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorComplementoAyudaInfancia"
        component={SimuladorComplementoInfancia}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorBonoCultural"
        component={SimuladorBonoCultural}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorAyudasDesacopladas"
        component={SimuladorAyudasDesacopladas}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorDesarrolloRural"
        component={SimuladorDesarrolloRural}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorMedidasSectoriales"
        component={SimuladorMedidasSectoriales}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="SimuladorRenovables"
        component={SimuladorRenovables}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorRehabilitacion"
        component={SimuladorRehabilitacion}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SimuladorMoves"
        component={SimuladorMovesIII}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="InformePensionNoContributiva"
        component={InformePensionNoContributiva}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeIngresoMinimoVital"
        component={InformeIngresoMinimoVital}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeBecaGeneral"
        component={InformeBecaGeneral}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeAyudasAlquiler"
        component={InformeAyudasAlquiler}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeLeyDependencia"
        component={InformeLeyDependencia}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeBonoJoven"
        component={InformeBonoJoven}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeAyudaAdquisicion"
        component={InformeAyudaAdquisicion}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeAvalHipoteca"
        component={InformeAvalHipoteca}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeAyudaNacimiento"
        component={InformeAyudaNacimiento}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeBecaApoyoEducativo"
        component={InformeBecaApoyoEducativo}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeAyudasDesacopladas"
        component={InformeAyudasDesacopladas}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeBecaResidencia"
        component={InformeBecaResidencia}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformePrestacionHijoDiscapacidad"
        component={InformePrestacionHijoDiscapacidad}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeAsistenciaSanitaria"
        component={InformeAsistenciaSanitaria}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="InformeSubsidioMovilidad"
        component={InformeSubsidioMovilidad}
        options={{ headerShown: false }}
      />
    </Stack.Navigator>
  );
