...
const SimuladorComplementoInfancia: React.FC = () => {
  ...
  const handleSimulacion = () => {
    ...
    setResultado(
      ingresosNum <= umbralIngresos
        ? `Cumples los requisitos. La ayuda estimada sería de €${ayudaTotal.toFixed(2)} al mes.`
  ...
  return (
    <ScrollView style={styles.container}>
        <AnuncioInt/>
      <Text style={styles.title}>Simulador Complemento de Ayuda para la Infancia</Text>
