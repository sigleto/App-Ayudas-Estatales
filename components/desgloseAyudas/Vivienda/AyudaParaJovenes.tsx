    ...
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.content}>
          Ayudas para jóvenes menores de 35 años para facilitar el disfrute de
          una vivienda ya sea en régimen de alquiler o mediante una ayuda
          directa a la adquisición de viviendas localizadas en municipios de
          menos de 5.000 habitantes. Información vigente en 2026.
        </Text>
        ...
        <Text style={styles.content}>
          <Text style={styles.bold}>
            Ayuda al alquiler (Bono Alquiler Joven):
          </Text>
          ...
          {"\n"} - 4IPREM si se trata de familias numerosas generales y personas
          con discapacidad
          {"\n"} - 5IPREM familias numerosas especiales y personas con
          determinados grados de discapacidad
          {"\n"}- Alquiler mensual máximo de 600 euros
          {"\n"}- Alquiler mensual máximo de 900 euros en determinados ámbitos
          definidos por las comunidades autónomas
          {"\n\n"}
        ...
        <Text style={styles.content}>
          ...
          {"\n\n"}
          <Text style={styles.bold}>Ayuda a la adquisición:</Text>
          {"\n"}- Hasta **10.800 euros** con un límite del **20%** del precio de
          adquisición (inferior a **100.000 euros**). Valores vigentes en 2026.
        </Text>
        ...
        <Text style={styles.content}>
          ...
          de cada comunidad autónoma, adjuntando documentación personal, fiscal
          y de la vivienda.
        </Text>
        ...
        <Text style={styles.content}>
          Plan Estatal de Vivienda 2023-2026 (BOE actualizado). Vigente en 2026.
        </Text>
        ...
        <Button
          ...
          onPress={() =>
            navigation.navigate("SimuladorAyudaJovenesAdquisicion")
          }
        />
      </View>
    </ScrollView>
