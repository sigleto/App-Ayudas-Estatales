...
const InformeIngresoMinimoVital: React.FC = () => {
  ...
  const { edad, ingresos, personas, discapacidad, resultado } =
    route.params || {};
    ...
    try {
      const contenidoHTML = `
        ...
        <body>
          ...
          <h3>Descripción:</h3>
          <p>El Ingreso Mínimo Vital (IMV) es una ayuda destinada a garantizar un nivel mínimo de ingresos para las personas en situación de vulnerabilidad económica. En 2026, la cuantía base es de **658,59 euros** mensuales para un adulto.</p>
